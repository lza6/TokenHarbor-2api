...
<header>
  ...
  <div class="hstat"><span>模型 <b id="hmodels">-</b></span><span>凭证 <b id="hcreds">-</b></span><span>版本 <b>0.2.0</b></span></div>
</header>
<main>
<nav>
...
async function loadOverview() {
  try {
    ...
    $('#ov-cards').innerHTML =
      ...
      `<div class="card"><div class="lbl">版本</div><div class="num">0.2.0</div></div>`;
